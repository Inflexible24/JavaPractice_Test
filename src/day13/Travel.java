...
public class Travel {
    public static void main(String[] args) {
        ...
        if (valid == "Yes") {
            ...
            System.out.println(" How many bags do you add? ");
            byte bags = input.nextByte();
            int bag = bags * 50 / 100;
            System.out.println("How many people are your travelling with?");
            ...
            if (people == 1) {
                ...
                System.out.println("Maximum number is 3");


            }

            System.out.println("Enter the name of people of with together");

            String nP = input.next(",");

            int totalCost = bag + cost + people;

            System.out.println("Your ticket is booked to " + country + " We have charged extra for " + bag + " bags" + " but you are traveling with people  so we are giving a discount. Your total cost is "+ totalCost);
